...
function App() {
  ...
  return (
<div style={{minHeight:'100vh',width:'100%'}} className='d-flex justify-content-center align-items-center bg-primary-subtle'>
...
<h3 className='text-center text-primary'>REGISTRATION FORM</h3>
    <div  className=" bg-transperant innerdiv p-5 rounded">
            ...
            <form >
                ...
                <Button disabled={isFirstNameInValid || isLastNameInValid || isAddressInValid || isEmailInValid || isMobileNumberInValid || isPasswordInValid } onClick={handleRegister} color='info' style={{width:'50%',height:'70px' }} variant="contained">REGISTER</Button>
